...
public class Bomber extends Node{
    ...
    public Bomber(String name, AssetManager assetManager, BulletAppState bulletAppState, Vector3f posicao){
        super(name);
